...
const DICT = {
  en: {
    ...
    'common.filterLabel': 'Filter messages',
    ...
    'session.context.tooltip': 'Context window: {{used}} / {{total}} tokens ({{pct}}%)',
    ...
    'tool.verb.searchedWeb': 'Searched the web',
    'tool.verb.fetched': 'Fetched',
    'tool.verb.delegated': 'Delegated',
    'tool.verb.skill': 'Ran skill',
    'tool.verb.todos': 'Updated todos',
  ...
  zh: {
    ...
    'session.meta.duration': '运行时长',
    'session.meta.context': '上下文',
    'session.context.tooltip': '上下文窗口：{{used}} / {{total}} tokens（{{pct}}%）',
    ...
    'tool.verb.searchedWeb': '网络搜索',
    'tool.verb.fetched': '抓取',
    'tool.verb.delegated': '委派',
    'tool.verb.skill': '运行技能',
    'tool.verb.todos': '更新待办',
