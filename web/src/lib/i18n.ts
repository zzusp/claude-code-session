...
const DICT = {
  en: {
    ...
    'session.chain.title': 'Chain',
    'session.chain.subtitle': 'Neural firing',
    'session.chain.openAria': 'Open the thinking / execution chain',
    'session.chain.close': 'Close',
    'session.chain.empty': 'This session has no chain to visualize yet.',
    'session.chain.capped': 'last {{n}} of {{m}} steps',
    'session.chain.jumpHint': 'Click to jump',
    'session.chain.kind.thinking': 'Thinking',
    'session.chain.kind.text': 'Reply',
    'session.chain.kind.tool': 'Tool call',
    'session.chain.kind.result': 'Result',
    'session.chain.kind.error': 'Error',
    'session.chain.kind.user': 'Prompt',
  ...
  zh: {
    ...
    'session.chain.title': '链路',
    'session.chain.subtitle': '神经放电',
    'session.chain.openAria': '打开思维 / 执行链',
    'session.chain.close': '关闭',
    'session.chain.empty': '本次会话还没有可可视化的链路。',
    'session.chain.capped': '最近 {{n}} / 共 {{m}} 步',
    'session.chain.jumpHint': '点击跳转',
    'session.chain.kind.thinking': '思考',
    'session.chain.kind.text': '回复',
    'session.chain.kind.tool': '工具调用',
    'session.chain.kind.result': '结果',
    'session.chain.kind.error': '报错',
    'session.chain.kind.user': '提问',
