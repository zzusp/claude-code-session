...
const DICT = {
  en: {
    ...
    'session.modified.subtitle':
      'Files this session touched via Edit / Write / MultiEdit / NotebookEdit.',
    ...
    'session.modified.expand': 'show',
    'session.modified.collapse': 'hide',
    'session.modified.col.file': 'File',
    'session.modified.col.ops': 'Operations',
    'session.modified.col.range': 'First → last',
    'session.modified.col.jump': 'Jump',
    'session.modified.opSummary': '{{n}} op',
    'session.modified.opSummaryPlural': '{{n}} ops',
    'session.modified.errorBadge': '{{n}} errored',
    'session.modified.absolutePath': 'absolute path',
    'session.modified.jump': 'Jump to',
    'session.modified.jumpAria': 'Jump to first edit of {{file}}',
  ...
  zh: {
    ...
    'session.modified.subtitle': '本次会话通过 Edit / Write / MultiEdit / NotebookEdit 触达过的文件。',
    ...
    'session.modified.expand': '展开',
    'session.modified.collapse': '收起',
    'session.modified.col.file': '文件',
    'session.modified.col.ops': '操作',
    'session.modified.col.range': '首次 → 最后',
    'session.modified.col.jump': '跳转',
    'session.modified.opSummary': '{{n}} 次',
    'session.modified.opSummaryPlural': '{{n}} 次',
    'session.modified.errorBadge': '{{n}} 次失败',
    'session.modified.absolutePath': '绝对路径',
    'session.modified.jump': '跳转到',
    'session.modified.jumpAria': '跳转到 {{file}} 的首次修改',
